...
_command_list = [
	CheckPlayerStats(), CheckSurvivalScores(), GetCrosshair(), PeekSkins(),
	GetClanRanking(), GetClanRank(), ClanPlayersStatus(), LobbyLinks(),
	Verify(), CollectBounty(), Credits(), SendCredits(), SuperDeploy(), Deploy(),
]
